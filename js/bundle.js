...
function cards() {
  ...
  (0,_servises_servises__WEBPACK_IMPORTED_MODULE_0__.getResource)('http://localhost:3000/menu').then(data => {
    data.forEach(_ref => {
      let {
        img,
        altimg,
...
function slider(_ref) {
  ...
  const slides = document.querySelectorAll(slide),
        ...
        current = document.querySelector(carrentCounter),
...
window.addEventListener('DOMContentLoaded', () => {
  const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.openModal)('.modal', modalTimerId), 180000);
